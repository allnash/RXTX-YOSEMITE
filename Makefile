...
target_triplet = i386-apple-darwin14.5.0
subdir = .
...
ACLOCAL = ${SHELL} /Users/ngadre/rxtx/rxtx-2.2pre2/missing --run aclocal-1.10
AMTAR = ${SHELL} /Users/ngadre/rxtx/rxtx-2.2pre2/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /Users/ngadre/rxtx/rxtx-2.2pre2/missing --run autoconf
AUTOHEADER = ${SHELL} /Users/ngadre/rxtx/rxtx-2.2pre2/missing --run autoheader
AUTOMAKE = ${SHELL} /Users/ngadre/rxtx/rxtx-2.2pre2/missing --run automake-1.10
AWK = awk
CC = gcc
...
F77 = 
FFLAGS = 
GLIBTOOL = $(SHELL) glibtool --tag=gcc
GREP = /usr/bin/grep
...
JAVA_VERSION = 1.8.0_40
JHOME = /Library/Java/JavaVirtualMachines/jdk1.8.0_40.jdk/Contents/Home/lib/ext
JPATH = /Library/Java/JavaVirtualMachines/jdk1.8.0_40.jdk/Contents/Home
LDFLAG = 
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /Users/ngadre/rxtx/rxtx-2.2pre2/missing --run makeinfo
...
THREAD_FLAG = 
TOP = /Users/ngadre/rxtx/rxtx-2.2pre2
VERSION = 2.2pre1
WINDOWS_JAVA_INCLUDE = 
XCODE_SELECT = /usr/bin/xcode-select
abs_builddir = /Users/ngadre/rxtx/rxtx-2.2pre2
abs_srcdir = $(TOP)/.
abs_top_builddir = /Users/ngadre/rxtx/rxtx-2.2pre2
abs_top_srcdir = /Users/ngadre/rxtx/rxtx-2.2pre2
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_F77 = 
am__include = include
...
install_sh = $(SHELL) /Users/ngadre/rxtx/rxtx-2.2pre2/install-sh
...
$(target_triplet)/librxtx%.jnilib: $(SPATH)/%Imp.c $(CLASSES) $(SPATH)/%Imp.h
	...
	if [ "$*" = "Serial" ]; then 					\
		$(LIBTOOLC) $(SPATH)/fuserImp.c -o		\
			$(TOP)/$(DEST)/fuserImp.o;	\
		cc  -bundle -framework CoreFoundation -framework IOKit -o librxtx$*.jnilib  $(TOP)/$(DEST)/$*Imp.o  	\
			$(TOP)/$(DEST)/fuserImp.o; 	\
	else								\
		cc  -bundle -framework CoreFoundation -framework IOKit -o librxtx$*.jnilib  $(TOP)/$(DEST)/$*Imp.o; 	\
	fi;								\
